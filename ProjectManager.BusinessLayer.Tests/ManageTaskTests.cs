...
namespace ProjectManager.BusinessLayer.Tests
{
    public class ManageTaskTests : IClassFixture<BusinessFixture>
    {
        ...
        [Fact]
        public async Task TestGetAllTasksAsync_VerifyGetAllAsyncCalledOnce()
        {
            var mockRepository = new Mock<ITaskRepository>();
            var manageTask = new ManageTask(mockRepository.Object, fixture.Logger);
            
            var result = await manageTask.GetAllTasksAsync();
        ...
        public void TestIsTaskValidToClose_ReturnFalseWhenTaskContainsChildTask()
        {
            ...
            {
                taskDetail,
                new TaskDetail() {Id = 2, Name ="Task 2 ", Priority = 20, ParentId = 1, ActiveStatus = true},
            };
        ...
        public void TestIsTaskValidToClose_ReturnTrueWhenTaskContainsChildTaskWhichIsNotActive()
        {
            ...
            {
                taskDetail,
                new TaskDetail() {Id = 2, Name ="Task 2 ", Priority = 20, ParentId = 1, ActiveStatus = false},
            };
        ...
        [Fact]
        public void TestIsTaskValidToClose_ReturnTrueWhenTaskDoesNotContainsChildTask()
        {
            var mockRepository = new Mock<ITaskRepository>();
            var manageTask = new ManageTask(mockRepository.Object, fixture.Logger);
            var taskDetail = new TaskDetail() { Id = 1, Name = "Task 1", Priority = 20 };
